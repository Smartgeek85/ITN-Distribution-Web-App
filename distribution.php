...
$dbUsername = "itntasko_camp"; // Use a different variable name for clarity
...
try {
    ...
    // Fetch data from the distribution table
    $stmt = $conn->query('SELECT * FROM distribution');
...
<body class="bg-body-light dark:bg-dark-body">
    ...
    <div class="main-content group-data-[sidebar-size=lg]:xl:ml-[calc(theme('spacing.app-menu')_+_16px)] group-data-[sidebar-size=sm]:xl:ml-[calc(theme('spacing.app-menu-sm')_+_16px)] px-4 ac-transition">
        <div class="card">
            <h2 class="card-title">ITN Distribution Report</h2>
        </div>
       ...
       <table id="basicDataTable" class="min-w-full bg-white border border-gray-200">
            <thead>
                <tr>
                    <th class="bg-[#B2E8D9] border px-4 py-2">Date</th>
                    <th class="bg-[#B2E8D9] border px-4 py-2">Household ID</th>
                    <th class="bg-[#B2E8D9] border px-4 py-2">Head of Household Name</th>
                    <th class="bg-[#B2E8D9] border px-4 py-2">Phone Number</th>
                    <th class="bg-[#B2E8D9] border px-4 py-2"># of Family Members</th>
                    <th class="bg-[#B2E8D9] border px-4 py-2">ITNs Assigned</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
                <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                    <tr>
                        <td class="border px-4 py-2"><?php echo htmlspecialchars($row['distribution_date']); ?></td>
                        <td class="border px-4 py-2"><?php echo htmlspecialchars($row['household_id']); ?></td>
                        <td class="border px-4 py-2"><?php echo htmlspecialchars($row['household_name']); ?></td>
                        <td class="border px-4 py-2"><?php echo htmlspecialchars($row['user_assigned']); ?></td>
                        <td class="border px-4 py-2"><?php echo htmlspecialchars($row['family_members']); ?></td>
                        <td class="border px-4 py-2"><?php echo htmlspecialchars($row['itns_distributed']); ?></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
